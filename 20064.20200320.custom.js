...
//mcr 24July2020 - modified to use collect API endpoint when sending data - look for this 24July2020 to find the modifications
...
(function (id, loader, u) {
  ...
  u.get_account_profile = function(s) {
      ...
      //mcr 24July2020 - TODO - need better here
      //the reason to return the array is that is what the function would return for a normal collect tag endpoint
      return ["tealiumiq.com", "telefonicauk", "lib-audience", "2", "i.gif"];
  ...
  u.send = function(a,b) {
    ...
    if(u.ev[a] || typeof u.ev["all"] !== "undefined"){
      ...
      ##UTEXTEND##
        ...
        //u.data.cfg=utag.cfg;
        //mcr 24July2020 - for now, just hardcoding tealium account and profile here - TODO - this needs to be done dynamically
        b.tealium_trace_id = b['cp.trace_id'];
        b.tealium_account = 'telefonicauk';
        b.tealium_profile = 'lib-audience';
        ...
        if (u.data_enrichment === "frequent" || u.data_enrichment === "infrequent") {
          ...
          //mcr24July2020 - extension changes tealium_visitor_id for login change, and stores the new value in utag.dle_visitor_id so we can use it here immediately
          //on the page refresh, it seems to be re-read into u.visitor_id anyway
      ...
      //mcr 24July2020 - allowed for switch to test image mode
      //mcr 24July2020 - even though we are not using formData here, we are still using the test for it to see whether to POST or simple GET, as that is what the standard collect tag does
        if (window.FormData && !utag.useImageForCollect) {
          ...
          function postData(server_index, enrichment_polling, enrichment_polling_delay) {
            ...
            //mcr 24July2020 - Collect API endpoint uses raw JSON, not form data
	    ...
	    //mcr 24July2020 - TODO - we are for now hardcoding the collect api endpoint on the configuration screen, but we should do something better.
            ...
            //mcr 24July2020 - change from standard collect tag - we are only interested in the inner data
          ...
          for (i = 0; i < u.server_list.length; i++) {
            (function(i, enrichment_polling, enrichment_polling_delay) {
              ...
              setTimeout( function(){
              //mcr 24July2020 - changed this for the collect api
                if (u.profile_specific_vid == 1 && u.visitor_id) {
